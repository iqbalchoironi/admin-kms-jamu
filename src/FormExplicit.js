...
class FormExplicit extends Component {
 ...
 async getData(){
  ...
  render() {
    ...
    const steps = ['Add Information Explicit Knowledge', 'AddDocument Explicit Knowledge', 'Term and Condition','Review'];
    const { activeStep } = this.state;
              ...
              <div style={{
               ...
               >
                ...
                <Button
                  ...
                  className={classes.button}>Submit</Button> : <Button
                variant="raised"
                color="primary"
                onClick={this.handleNext}
    ...
    <form style={{ width: "90%" }}>
        <div style={{
          ...
          <FormControl margin="normal" fullWidth>
            ...
            <Input style={{ marginRight: "15px"}} onChange={props.handleChange} id="firstName" name="firstName" type="text" />
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="lastName">Last Name</InputLabel>
            <Input  id="lastName" onChange={props.handleChange} name="lastName" type="text" />
          </FormControl>
        </div>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="title">Title</InputLabel>
            <Input  id="title" onChange={props.handleChange} type="text" name="title"/>
          </FormControl>

          <FormControl margin="normal" fullWidth>
            {/* <InputLabel htmlFor="email">Date Publish</InputLabel> */}
            <Input id="datePublish" onChange={props.handleChange} type="date" name="datePublish"/>
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="Citation">citation</InputLabel>
            <Input  id="citation" onChange={props.handleChange} type="text" name="citation"/>
          </FormControl>
        ...
        <FormControl margin="normal" fullWidth>
            ...
            <Input id="abstract" onChange={props.handleChange} name="abstract" multiline rows={10} />
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="description">Description</InputLabel>
            <Input id="description" onChange={props.handleChange} name="description" multiline rows={10} />
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="publisher">Publisher</InputLabel>
            <Input  id="publisher" onChange={props.handleChange} type="text" name="publisher"/>
          </FormControl>
      </form>
      </Paper>
  );
