...
const rows = [
  ...
  { id: 'disease', numeric: true, disablePadding: false, label: 'Disease' },
  { id: 'use', numeric: true, disablePadding: false, label: 'Use' },
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{n.disease}</TableCell>
                      <TableCell align="right">{n.use}</TableCell>
                      <TableCell align="right">{n.section}</TableCell>
                      <TableCell align="right">{n.family}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
