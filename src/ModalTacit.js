    ...
    <form style={{ width: "90%" }}>
        ...
        <FormControl margin="normal" fullWidth>
          ...
          <FormControl margin="normal" fullWidth>
            ...
            <Input style={{ marginRight: "15px"}} value={this.state.title} onChange={this.valueChange} id="title" name="title" type="text" />
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="content">Content</InputLabel>
            <Input  id="content" value={this.state.content} onChange={this.valueChange} name="content" type="text" />
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="reference">Reference</InputLabel>
            <Input id="reference" value={this.state.reference} onChange={this.valueChange} type="text" name="reference"/>
          </FormControl>
      </form>
      </Paper>
          </DialogContent>
