    ...
    <form style={{ width: "90%" }}>
        ...
        <div style={{
          ...
          <FormControl margin="normal" fullWidth>
            ...
            <Input style={{ marginRight: "15px"}} value={this.state.firstName} onChange={this.valueChange} id="firstName" name="firstName" type="text" />
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="lastName">Last Name</InputLabel>
            <Input  id="lastName" value={this.state.lastName} onChange={this.valueChange} name="lastName" type="text" />
          </FormControl>
        </div>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="title">Title</InputLabel>
            <Input  id="title" value={this.state.title} onChange={this.valueChange} type="text" name="title"/>
          </FormControl>

          <FormControl margin="normal" fullWidth>
            {/* <InputLabel htmlFor="email">Date Publish</InputLabel> */}
            <Input id="datePublish" value={this.state.datePublish} onChange={this.valueChange} type="date" name="datePublish"/>
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="Citation">citation</InputLabel>
            <Input  id="citation" value={this.state.citation} onChange={this.valueChange} type="text" name="citation"/>
          </FormControl>
          ...
          >
            <FormControlLabel value="indonesian" control={<Radio />} label="Indonesia (Bahasa)" />
        ...
        <FormControl margin="normal" fullWidth>
            ...
            <Input id="abstract" value={this.state.abstract} onChange={this.valueChange} name="abstract" multiline rows={10} />
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="description">Description</InputLabel>
            <Input id="description" value={this.state.description} onChange={this.valueChange} name="description" multiline rows={10} />
          </FormControl>

          <FormControl margin="normal" fullWidth>
            <InputLabel htmlFor="publisher">Publisher</InputLabel>
            <Input  id="publisher" value={this.state.publisher} onChange={this.valueChange} type="text" name="publisher"/>
          </FormControl>
      </form>
      </Paper>
          </DialogContent>
